...
public class OrderTransport {
	...
	private Set transportCommoditys = new HashSet(0);
	public void setTransportCommoditys(Set<TransportCommodity> transportCommodity){
		this.transportCommoditys = transportCommodity;
	}
	
	public Set<TransportCommodity> getTransportCommoditys() {
		return transportCommoditys;
	}
	...
	public boolean equals(Object obj) {
		if(obj instanceof OrderTransport == false) return false;
		if(this == obj) return true;
		OrderTransport other = (OrderTransport)obj;
