...
public class MemberQuery extends PageQuery {
	...
	/** secondlogtime */
	private java.util.Date secondlogtimeBegin;
	private java.util.Date secondlogtimeEnd;
	/** sex */
	...
	/** restpasstime */
	private java.util.Date restpasstimeBegin;
	private java.util.Date restpasstimeEnd;
	/** isdeleted */
	...
	/** established */
	private java.util.Date establishedBegin;
	private java.util.Date establishedEnd;
	/** registrationid */
	...
	/** closeTime */
	private java.util.Date closeTimeBegin;
	private java.util.Date closeTimeEnd;
	...
	public java.util.Date getSecondlogtimeBegin() {
		return this.secondlogtimeBegin;
	}
	
	public void setSecondlogtimeBegin(java.util.Date value) {
		this.secondlogtimeBegin = value;
	}	
	
	public java.util.Date getSecondlogtimeEnd() {
		return this.secondlogtimeEnd;
	}
	
	public void setSecondlogtimeEnd(java.util.Date value) {
		this.secondlogtimeEnd = value;
	}
	...
	public java.util.Date getRestpasstimeBegin() {
		return this.restpasstimeBegin;
	}
	
	public void setRestpasstimeBegin(java.util.Date value) {
		this.restpasstimeBegin = value;
	}	
	
	public java.util.Date getRestpasstimeEnd() {
		return this.restpasstimeEnd;
	}
	
	public void setRestpasstimeEnd(java.util.Date value) {
		this.restpasstimeEnd = value;
	}
	...
	public java.util.Date getEstablishedBegin() {
		return this.establishedBegin;
	}
	
	public void setEstablishedBegin(java.util.Date value) {
		this.establishedBegin = value;
	}	
	
	public java.util.Date getEstablishedEnd() {
		return this.establishedEnd;
	}
	
	public void setEstablishedEnd(java.util.Date value) {
		this.establishedEnd = value;
	}
	...
	public java.util.Date getCloseTimeBegin() {
		return this.closeTimeBegin;
	}
	
	public void setCloseTimeBegin(java.util.Date value) {
		this.closeTimeBegin = value;
	}	
	
	public java.util.Date getCloseTimeEnd() {
		return this.closeTimeEnd;
	}
	
	public void setCloseTimeEnd(java.util.Date value) {
		this.closeTimeEnd = value;
	}
