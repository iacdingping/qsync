...
import com.openteach.qsync.core.order.OrderDao;
...
//	private Set orderStatuss = new HashSet(0);
	...
	private Set orderfreightquotations = new HashSet(0);
	public void setOrderfreightquotations(Set<Orderfreightquotation> orderfreightquotation){
		this.orderfreightquotations = orderfreightquotation;
	}
	
	public Set<Orderfreightquotation> getOrderfreightquotations() {
		return orderfreightquotations;
	}
	
	private Set orderTransports = new HashSet(0);
	public void setOrderTransports(Set<OrderTransport> orderTransport){
		this.orderTransports = orderTransport;
	}
	
	public Set<OrderTransport> getOrderTransports() {
