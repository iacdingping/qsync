...
public class OrderTransport {
	...
	public static final String ALIAS_ADDRESSOR_COUNTRY = "发件人国别";
	public static final String ALIAS_ADDRESSOR_CITY = "发件人城市";
	public static final String ALIAS_ADDRESSOR_NAME = "发件人姓名";
	public static final String ALIAS_ZIP_CODE = "收件人邮编";
	public static final String ALIAS_CONSIGNEE_EMAIL = "收件人邮箱";
