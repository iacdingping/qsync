 ...
 * @since 1.0
 * */
public class CommodityQuery extends PageQuery {
	...
	/** validTime */
	private java.util.Date validTimeBegin;
	private java.util.Date validTimeEnd;
	/** auditTime */
	private java.util.Date auditTimeBegin;
	private java.util.Date auditTimeEnd;
	/** lastTradingTime */
	private java.util.Date lastTradingTimeBegin;
	private java.util.Date lastTradingTimeEnd;
	/** updatedatetime */
	...
	public java.util.Date getValidTimeBegin() {
		return this.validTimeBegin;
	}
	
	public void setValidTimeBegin(java.util.Date value) {
		this.validTimeBegin = value;
	}	
	...
	public void setValidTimeEnd(java.util.Date value) {
		this.validTimeEnd = value;
	}
	
	public java.util.Date getAuditTimeBegin() {
		return this.auditTimeBegin;
	}
	
	public void setAuditTimeBegin(java.util.Date value) {
		this.auditTimeBegin = value;
	}	
	
	public java.util.Date getAuditTimeEnd() {
		return this.auditTimeEnd;
	}
	
	public void setAuditTimeEnd(java.util.Date value) {
		this.auditTimeEnd = value;
	}
	
	public java.util.Date getLastTradingTimeBegin() {
		return this.lastTradingTimeBegin;
	}
	
	public void setLastTradingTimeBegin(java.util.Date value) {
		this.lastTradingTimeBegin = value;
	}	
	
	public java.util.Date getLastTradingTimeEnd() {
		return this.lastTradingTimeEnd;
	}
	
	public void setLastTradingTimeEnd(java.util.Date value) {
		this.lastTradingTimeEnd = value;
	}
