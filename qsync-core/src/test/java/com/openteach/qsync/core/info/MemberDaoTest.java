...
public class MemberDaoTest extends SpringTransactionalTestCase{
	...
	public void memberCurl() throws Exception {
		...
		assertEquals(MemberQueried.getRegtime(), member.getRegtime());
		...
		assertEquals(MemberQueried.getLastlogtime(), member.getLastlogtime());
		assertEquals(MemberQueried.getSecondlogtime(), member.getSecondlogtime());
		assertEquals(MemberQueried.getSex(), member.getSex());
		assertEquals(MemberQueried.getBirthday(), member.getBirthday());
		...
		assertEquals(MemberQueried.getOrdertime(), member.getOrdertime());
		assertEquals(MemberQueried.getRestpasstime(), member.getRestpasstime());
		...
		assertEquals(MemberQueried.getEstablished(), member.getEstablished());
		...
		assertEquals(MemberQueried.getCloseTime(), member.getCloseTime());
		...
		assertEquals(memberUpdated.getRegtime(), member.getRegtime());
		...
		assertEquals(memberUpdated.getLastlogtime(), member.getLastlogtime());
		assertEquals(memberUpdated.getSecondlogtime(), member.getSecondlogtime());
		assertEquals(memberUpdated.getSex(), member.getSex());
		assertEquals(memberUpdated.getBirthday(), member.getBirthday());
		...
		assertEquals(memberUpdated.getOrdertime(), member.getOrdertime());
		assertEquals(memberUpdated.getRestpasstime(), member.getRestpasstime());
		...
		assertEquals(memberUpdated.getEstablished(), member.getEstablished());
		...
		assertEquals(memberUpdated.getCloseTime(), member.getCloseTime());
